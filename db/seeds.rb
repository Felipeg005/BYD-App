...
Payment.create(author_id: 1, category_id: 1, name:'Test Payment', amount: 30)
Payment.create(author_id: 1, category_id: 1, name:'Test Payment', amount: 60)
Payment.create(author_id: 2, category_id: 2, name:'Test Payment', amount: 30)